...
parser.add_argument("--CommercialLoan", type=float, default=0.00,
                    help="商业贷款额度, 单位元, 非负实数, 缺省值为0")
parser.add_argument("--CommercialRate", type=float, default=0.00,
                    help="商业贷款利率(年化), 非负实数, 缺省值为0, 输入时应当已乘以100, 例如%%3输入3即可")
parser.add_argument("--CommercialMode", type=int, default=0,
                    help="商业贷款模式, 0:等额本息, 1:等额本金")

parser.add_argument("--NonCommercialLoan", type=float, default=0,
                    help="公积金贷款额度, 单位元, 非负实数, 缺省值为0")
parser.add_argument("--NonCommercialRate", type=float, default=0,
                    help="公积金贷款利率(年化), 非负实数, 缺省值为0, 输入时应当已乘以100, 例如%%3输入3即可")
parser.add_argument("--NonCommercialMode", type=int, default=0,
                    help="公积金贷款模式, 0:等额本息, 1:等额本金")

parser.add_argument("--Months", type=int, default=12,
                    help="贷款期数, 单位月, 缺省值为12, 例如贷款30年输入360")
